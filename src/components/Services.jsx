    ...
    <div className='min-h-screen flex flex-col justify-center items-center px-4 xl:py-0 py-10'>
      ...
      <div className='w-full xl:w-[900px] lg:w-[800px] md:w-[600px] grid lg:grid-cols-3 grid-cols-1 lg:gap-12 gap-18 xl:mb-0 mb-16'>
        {skillCards.map((card, index) => (
            <div key={index} className='lg:max-w-[280px] md:max-w-w[400px] max-w-[320px] w-full mx-auto rounded-sm ring-2 ring-gray-400/20 shadow-md shadow-gray-700/20 relative'>
                ...
                <div className={`w-full absolute left-0 ${getPositionClass(card)} flex flex-col gap-y-5 py-4`}>
